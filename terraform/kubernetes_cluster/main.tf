resource "google_container_cluster" "pet_clinic" {
  name     = "pet-clinic"
  location = var.region
...
resource "google_container_node_pool" "pet_clinic_linux_node_pool" {
  name           = "${google_container_cluster.pet_clinic.name}--linux-node-pool"
  location       = google_container_cluster.pet_clinic.location
  node_locations = var.node_zones
  cluster        = google_container_cluster.pet_clinic.name
  node_count     = 3
